...
function LoginPage() {
    ...
    const handleGoogleSignIn = async ()=>{
        setLoading(true);
        const { user, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithGoogle"])();
        setLoading(false);
        if (error) {
            toast({
                variant: "destructive",
    ...
    const handleEmailSignIn = async (e)=>{
        e.preventDefault();
        setLoading(true);
        const { user, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithEmail"])(signInEmail, signInPassword);
        setLoading(false);
        if (error) {
            toast({
                variant: "destructive",
    ...
    const handleEmailSignUp = async (e)=>{
        e.preventDefault();
        setLoading(true);
        const { user, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signUpWithEmail"])(signUpEmail, signUpPassword, signUpName);
        setLoading(false);
        if (error) {
            toast({
                variant: "destructive",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1f24080d._.js.map